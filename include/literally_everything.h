...
extern Gfx *make_gfx_mario_alpha(struct GraphNodeGenerated *node, s16 alpha);
// src/game/hud.c
...
extern UNUSED void set_pos_to_mario(Vec3f foc, Vec3f pos, f32 yOff, f32 focYOff, f32 dist, s16 pitch, s16 yaw);
...
extern void stub_camera_1(UNUSED s32 unused);
...
extern UNUSED void unused_mode_0f_camera(struct Camera *c);
...
extern void unused_set_pos_rel_mario(struct Camera *c, f32 leftRight, f32 yOff, f32 forwBack, s16 yawOff);
...
extern UNUSED void stop_transitional_movement(void);
...
extern UNUSED BAD_RETURN(s32) cam_castle_leave_spiral_stairs(struct Camera *c);
...
extern UNUSED void unused_cutscene_mario_dialog_looking_down(UNUSED struct Camera *c);
extern BAD_RETURN(s32) cutscene_mario_dialog(UNUSED struct Camera *c);
extern UNUSED void unused_cutscene_mario_dialog_looking_up(UNUSED struct Camera *c);
...
extern UNUSED void unused_vec3s_to_vec3f(Vec3f dst, Vec3s src);
extern UNUSED void unused_vec3f_to_vec3s(Vec3s dst, Vec3f src);
extern void pan_camera(struct Camera *c, s16 incPitch, s16 incYaw);
extern UNUSED void unused_start_bowser_bounce_shake(UNUSED struct Camera *c);
...
extern void stub_camera_5(UNUSED struct Camera *c);
extern void focus_in_front_of_mario(struct Camera *c, f32 dist, f32 speed);
extern BAD_RETURN(s32) cutscene_dance_unused(UNUSED struct Camera *c);
...
extern void unused_water_death_move_to_side_of_mario(struct Camera *c);
extern void unused_cutscene_goto_cvar(struct Camera *c);
extern void unused_cam_to_mario(struct Camera *c);
extern UNUSED BAD_RETURN(s32) unused_cap_switch_retrieve_info(struct Camera *c);
...
extern UNUSED void unused_deactivate_sleeping_camera(UNUSED struct MarioState *m);
...
extern UNUSED void unused_approach_fov_30(UNUSED struct MarioState *m);
...
extern UNUSED void unused_displace_obj_randomly(struct Object *o, f32 xRange, f32 yRange, f32 zRange);
extern UNUSED void unused_rotate_obj_randomly(struct Object *o, f32 pitchRange, f32 yawRange);
...
extern s32 play_mode_unused(void);
...
extern u8 *alloc_ia8_text_from_i1(u16 *in, s16 width, s16 height);
...
extern void stub_is_textbox_active(u16 *a0);
...
extern BAD_RETURN(u32) update_water_pitch(struct MarioState *m);
...
extern void reset_float_globals(struct MarioState *m);
...
extern void *dynamic_dma_read(u8 *srcStart, u8 *srcEnd, u32 side);
...
extern struct MarioAnimDmaRelatedThing *func_802789F0(u8 *srcAddr);
...
extern u32 unused_determine_knockback_action(struct MarioState *m);
...
extern u32 interact_stub(UNUSED struct MarioState *m, UNUSED u32 interactType, struct Object *o);
...
extern int obj_is_in_view(struct GraphNodeObject *node, Mat4 matrix);
...
extern s32 is_in_mystery_snow_area(s32 x, UNUSED s32 y, s32 z);
...
extern u16 unused_get_elapsed_time(u64 *cycleCounts, s32 index);
...
extern void stub_obj_helpers_1(void);
...
extern void stub_obj_helpers_2(void);
...
extern void stub_obj_helpers_5(void);
...
extern void spawn_macro_coin_unknown(const BehaviorScript *behavior, s16 a1[]);
...
// src/game/skybox.c
extern int get_top_left_tile_idx(s8 player);
...
extern void unused_delete_leaf_nodes(struct Object *obj);
...
extern void goto_behavior_unused(const BehaviorScript *bhvAddr);
...
extern void stub_behavior_script_1(void);
...
// extern void bhv_cmd_set_int_random_from_table(s32 tableSize);
// extern s32 bhv_cmd_set_int_random_from_table(void);
...
extern void stub_surface_load_1(void);
...
extern void load_surfaces(s16 **data, s16 *vertexData, s16 surfaceType, s8 **surfaceRooms);
extern s16 *read_vertex_data(s16 **data);
...
extern void unused_80383604(void);
...
extern struct Surface *find_ceil_from_list(struct SurfaceNode *surfaceNode, s32 x, s32 y, s32 z, f32 *pheight);
...
extern struct Surface *find_floor_from_list(struct SurfaceNode *surfaceNode, s32 x, s32 y, s32 z, f32 *pheight);
