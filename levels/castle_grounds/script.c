...
static const LevelScript script_func_local_1[] = {
    ...
    //OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_16, /*pos*/  -2500, 260,  4500, /*angle*/ 0, 0, 0, /*behParam*/ 0x001F0000, /*beh*/ bhvWarpPipe),
    WARP_NODE(/*id*/ 0x1F, /*destLevel*/ LEVEL_JRB, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    //OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_16, /*pos*/  -2500, 260,  5000, /*angle*/ 0, 0, 0, /*behParam*/ 0x00200000, /*beh*/ bhvWarpPipe),
    WARP_NODE(/*id*/ 0x20, /*destLevel*/ LEVEL_LLL, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    RETURN(),
};
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_REX, /*pos*/  -1975, 260, 4366, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvRex),
    OBJECT(/*model*/ MODEL_GALOOMBA, /*pos*/  0, 850, -2500, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvGaloomba),
    OBJECT(/*model*/ MODEL_BLOOPER, /*pos*/  6115, -1100, 4076, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBlooper),
    ...
    //OBJECT(/*model*/ MODEL_LASER_RING_SPAWNER, /*pos*/  -1028, 260, 5264, /*angle*/ 0, 0, 0, /*behParam*/ 0x00010000, /*beh*/ bhvLaserRingSpawner),
    //OBJECT(/*model*/ MODEL_LASER_RING_SPAWNER, /*pos*/  -1628, 260, 5264, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLaserRingSpawner),
    OBJECT(/*model*/ MODEL_SPIKE, /*pos*/  5346, 374, -1869, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSpike),
    OBJECT(/*model*/ MODEL_STROLLIN_STU, /*pos*/  -515, 260, 4152, /*angle*/ 0, 0, 0, /*behParam*/ 0x01280000, /*beh*/ bhvStrollinStu),
    RETURN(),
};
